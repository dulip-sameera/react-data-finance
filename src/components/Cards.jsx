    ...
    <div className='w-full py-[10rem] px-4 bg-white'>
        <div className='max-w-[1240px] mx-auto grid  gap-8 md:grid-cols-3'>
            ...
            <div className='w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300'>
                ...
                <button className='bg-green w-[200px] rounded-md font-medium my-6 mx-auto py-3'>Start Trail</button>
            </div>

            {/* Card 2 */}
            <div className='w-full shadow-xl flex flex-col p-4 my-8 rounded-lg duration-300 bg-gray-100 hover:scale-105 md:my-0'>
                ...
                <button className='bg-black text-green w-[200px] rounded-md font-medium my-6 mx-auto py-3'>Start Trail</button>
            </div>
